...
run mypy uv run --locked mypy src scripts/bootstrap_environment.py scripts/review_model_benchmark.py scripts/run_feature_ablation.py scripts/run_model_tuning.py scripts/review_feature_ablation.py || exit $?
